...
%
% paper title
\title{A Technical Specification for\\Research Software Sustainability}
...
sustinability. Enumerating an explicit standard -- one that would emerge,
...
of data and other research artefacts, including
figshare\footnote{\url{http://figshare.com/}}, Open Science
Framework\footnote{\url{https://osf.io/}} and
GitHub\footnote{\url{https://github.com/}}. While there has been a
...
sharing of protocols and materials (\emph{open
